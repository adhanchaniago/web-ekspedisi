                        ...
                        <!--Start Signup Area-->
                            <div class="container slider_area_signup_form">
                                    <div class="row">
                                        ...
                                        <h2>get free quote only takes 1 minute</h2>
                                        <div class="signup_form">
                                            <form action="process.php">
                                            <input type="text" placeholder="Your Name" required>
                                            <input type="email" placeholder="Email Address" required>
                                            <input type="text" placeholder="Phone" required>
                                            <input type="text" placeholder="Type Of Move" required>
                                            <input type="text" placeholder="Form zip" required>
                                            <input type="text" placeholder="To zip" required>
                                            <p class="text-left"><button type="submit">GET A QUATE</button></p>
                                            </form>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-10 col-lg-10 col-md-offset-1 col-lg-offset-1">
                        <div class="page_title text-center">
                            <h2>WElCOME TO EXPRESS MOVERS</h2>
                ...
                <div class="row">
                    <div class="col-md-4 col-lg-4 ">
                        <div class="home_two_single_promotions text-center">
                            <div class="s_promotion_icon">
                                <img src="img/home_2/truck_icon.png" alt="">
                            </div>
                    ...
                    <div class="col-md-4 col-lg-4 ">
                        <div class="home_two_single_promotions text-center">
                            <div class="s_promotion_icon">
                                <img src="img/home_2/hand_icon.png" alt="">
                            </div>
                    ...
                    <div class="col-md-4 col-lg-4 ">
                        <div class="home_two_single_promotions text-center">
                            <div class="s_promotion_icon icon_clock">
                                <img src="img/home_2/clock_icon.png" alt="">
                            </div>
           ...
           <div class="all_project_oerly"></div>
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-lg-3 col-sm-12 col-xs-12">
                        <div class="single_project">
                            <div class="project_details">
                                <i class="fa fa-smile-o"><span>120</span></i>
                    ...
                    <div class="col-md-3 col-lg-3 col-sm-12 col-xs-12">
                        <div class="single_project">
                            <img src="img/home_2/project_2.jpg" alt="">
                        </div>
                    </div>
                    <div class="col-md-3 col-lg-3 col-sm-12 col-xs-12">
                        <div class="single_project">
                            <div class="project_details">
                                <i class="fa fa-briefcase "><span>80</span></i>
                    ...
                    <div class="col-md-3 col-lg-3 col-sm-12 col-xs-12">
                        <div class="single_project">
                            <img src="img/home_2/project_4.jpg" alt="">
                        </div>
                    </div>
                    <div class="col-md-3 col-lg-3 col-sm-12 col-xs-12">
                        <div class="single_project">
                    ...
                    <div class="col-md-3 col-lg-3 col-sm-12 col-xs-12">
                        <div class="single_project">
                            <div class="project_details">
                                <i class="fa fa-clock-o"><span>230</span></i>
                                <p>hours worked</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-lg-3 col-sm-12 col-xs-12">
                        <div class="single_project">
                            <img src="img/home_2/project_6.jpg" alt="">
                        </div>
                    </div>
                    <div class="col-md-3 col-lg-3 col-sm-12 col-xs-12">
                        <div class="single_project">
                            <div class="project_details">
                                <i class="fa fa-file-audio-o "><span>100</span></i>
                                <p>quotes sent</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-6">
                        <div class="single_client">
                            <div class="client_img">
                                <img src="img/home_2/client_discription_3.png" alt="">
                            </div>
                            <div class="client_discription">
                                <h5>guiso lee</h5>
                                <p class="client_address">sydney,australia</p>
                                <p>Movin' on up to the east side. We finally got a piece of the pie. Here's the story of a lovely lady who was bringing up three very lovely girls. They were four men living all together yet they were all alone.</p>
                                <div class="rating_area">
                                    <p class="text-left">100% recomended</p>
                                    <div class="ratting text-right">
                                        <i class="fa fa-star"></i>
                    ...
                    <div class="col-md-6 col-lg-6">
                        <div class="single_client">
                            <div class="client_img">
                                <img src="img/home_2/client_discription_4.png" alt="">
                            </div>
                            <div class="client_discription">
                                <h5>wax edison</h5>
                                <p class="client_address">sydney,australia</p>
                                <p>Just sit right back and you'll hear a tale a tale of a fateful trip that started from this tropic port aboard this tiny ship! Here's the 
story of a lovely lady who was three very lovely girls.</p>
                                <div class="rating_area">
                                    <p class="text-left">100% recomended</p>
                                    <div class="ratting text-right">
                                        <i class="fa fa-star"></i>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        <div class="single_blog">
                            <div class="blog_img">
                                <a href=""><img src="img/home_2/blog_1.jpg" alt=""></a>
                                <div class="blog_date">
                            ...
                            <div class="blog_content">   
                                ...
                                <h3><a href="#">Well the first thing you know ol' Jeds a millionaire 
Kinfolk said Jed move away from there</a></h3>
                                <p>Today still wanted by the government they survive as soldiers of fortune. Movin' on up to the east side. We finally got a piece of the pie. Here's the story of a lovely alone.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        <div class="single_blog">
                            <div class="blog_img">
                                <a href=""><img src="img/home_2/blog_2.jpg" alt=""></a>
                                <div class="blog_date">
                                    <p class="Blog_month">24 <span>June</span></p>
                                    <p class="blog_year">2015</p>
                                </div>
                            ...
                            <div class="blog_content">   
                                <p class="blog_name">By/John Smith</p>
                                <h3><a href="#">Just sit right back and you'll hear a tale a tale of a
fateful trip that started</a></h3>
                                <p>These men promptly escaped from a maximum security stockade to the Los Angeles underground. Then one day he was shootin' at some food and up through the ground . It's time to play the music. </p>
                            </div>
                        </div>
                    </div>
                </div>
